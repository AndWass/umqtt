...
A small and opinionated MQTT client library targeting embedded
devices. Requires no allocations.

## Features

  - [x] Sans-IO base-client.
    - `umqtt::transport_client::TransportClient`
  - [x] Small opinionated async client
    - `umqtt::nano_client::NanoClient`
  - [ ] More featured opinionated async client
    - Should keep track of in-flight publishes and available packet IDs.
    - Target name should be `umqtt::MicroClient`.
